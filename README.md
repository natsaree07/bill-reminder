...
เมื่อระดับความเร่งด่วนเปลี่ยนไป ระบบจะตั้งค่า flag สำหรับการแจ้งเตือนใหม่
เพื่อให้ Notifier Worker ตรวจพบและส่งอีเมลแจ้งเตือนตามระดับความเร่งด่วน

จุดแจ้งเตือนสามารถปรับได้ผ่าน Environment Variable
`REMINDER_THRESHOLDS` เช่น `"7,3,1"` ซึ่งหมายถึงจุดแจ้งเตือนที่
7 วัน, 3 วัน และ 1 วันก่อนถึงกำหนด
...
<<<<<<< HEAD
ชื่อ-นามสกุล / รหัสนักศึกษา: นายนัสรี ม่องพร้า รหัส 166404140070
=======
ชื่อ-นามสกุล: นายนัสรี ม่องพร้า  
รหัสนักศึกษา: 166404140070 
สาขาวิศวกรรมคอมพิวเตอร์  
มหาวิทยาลัยเทคโนโลยีราชมงคลศรีวิชัย
>>>>>>> e69cdfe (Update Readme)
